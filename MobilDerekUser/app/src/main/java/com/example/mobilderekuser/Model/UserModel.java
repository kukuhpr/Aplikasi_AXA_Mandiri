...
public class UserModel {
    ...
    private String uid, emailUser, namaUser, noHpUser, passUser, conPassUser,
            countryUser, stateUser, cityUser, alamatUser, latitude, longitude,
            timeStamp, accountType, online, profileImage;
    ...
    public String getConPassUser() {
        return conPassUser;
    }

    public void setConPassUser(String conPassUser) {
        this.conPassUser = conPassUser;
    }
